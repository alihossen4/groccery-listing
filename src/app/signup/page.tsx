        ...
        <section className="w-[30%] mx-auto my-10 py-3 shadow-md">
            ...
            <div className="w-[500px] mx-auto my-4">
                <form action="" method="post">
                    ...
                    <input type="text" name="name" className="border border-gray p-2 my-2 focus:outline-none rounded-md border-2" />
                    <br />
                    <label htmlFor="email" className="text-2xl px-5 py-2 mr-11 ">Email : </label>
                    <input type="email" name="email" className="border border-gray p-2 my-2 focus:outline-none rounded-md border-2" />
                    <br />
                    <label htmlFor="password" className="text-2xl px-5 py-2 ">Password : </label>
                    <input type="password" name="password" className="border border-gray p-2 my-2 focus:outline-none rounded-md border-2" />
                    <br />
