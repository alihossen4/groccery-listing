...
const LatestItem: React.FC<ProductItemProps> = ({image, price, oldPrice}) => {
  return (
    <div className="product-item shadow-md bg-white rounded-md w-[200px]">
      <Link href={"/"} className="img overflow-hidden group flex p-3" >
        <Image src={image} alt="Beverage 1" className="transition group-hover:scale-105 w-full object-contain"/>
      </Link>
